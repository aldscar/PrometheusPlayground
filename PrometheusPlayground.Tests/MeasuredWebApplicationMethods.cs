...
{
    public class MeasuredWebApplicationMethods
    {
        ...
        public void Setup()
        {
            var builder = new WebHostBuilder()
                ...
                .UseStartup<MeasuredWebApplication.Startup>()
                .UseTestServer();
        ...
        [Test]
        public async Task CallWeatherForecastEndpoint()
        {
            var output = await Send(HttpMethod.Get, "/WeatherForecast");
            Assert.IsNotNull(output);
            var deserialized = JsonSerializer.Deserialize<MeasuredWebApplication.WeatherForecast[]>(output);
